    ...
    <div className="pt-20">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-sm p-8 border border-white/20">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 bg-white/20 backdrop-blur-sm border border-white/30 rounded-sm text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-orange-500"
                  />
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="bg-white/10 backdrop-blur-lg rounded-sm p-6 text-center border border-white/20">
                  <IoIosPeople className="h-8 w-8 text-blue-400 mx-auto mb-2" />
      ...
      <section className="py-16 bg-gradient-to-br from-orange-50 to-red-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Popular Questions</h2>
            <p className="text-xl text-gray-600">Quick answers to our most frequently asked questions</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {popularFAQs.map((faq, index) => (
              <motion.div
                ...
                className="bg-white rounded-sm p-6 shadow-lg hover:shadow-xl transition-all duration-300 group cursor-pointer"
                onClick={() => setOpenFAQ(faqs.indexOf(faq))}
              >
                <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-sm p-3 w-fit mb-4 group-hover:scale-110 transition-transform">
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-sm p-2 group-hover:scale-110 transition-transform">
                      ...
                      <div>
                        ...
                        {faq.popular && (
                          <span className="ml-3 inline-flex items-center px-2.5 py-0.5 rounded-sm text-xs font-medium bg-orange-100 text-orange-800">
                            Popular
                          </span>
                        )}
                      </div>
                    ...
                    <ChevronDown
                      className={`h-6 w-6 text-gray-500 transition-transform group-hover:text-orange-500 ${
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h2 className="text-4xl font-bold mb-6">Still have a question?</h2>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <textarea
                  ...
                  rows="4"
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-sm text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-orange-500 resize-none"
                ></textarea>
