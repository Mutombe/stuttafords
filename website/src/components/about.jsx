...
const AboutPage = () => {
  ...
  const clients = [
    { name: "CBZ", logo: "https://via.placeholder.com/100x60?text=CBZ", industry: "Banking" },
    { name: "PSMI", logo: "https://via.placeholder.com/100x60?text=PSMI", industry: "Manufacturing" },
    { name: "Delta", logo: "https://via.placeholder.com/100x60?text=Delta", industry: "Beverages" },
    { name: "Nyaradzo", logo: "https://via.placeholder.com/100x60?text=Nyaradzo", industry: "Funeral Services" },
    { name: "ZETDC", logo: "https://via.placeholder.com/100x60?text=ZETDC", industry: "Energy" }
  ];
    ...
    return (
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-3 sm:p-4">
          <div className={`${isCenter ? 'w-12 sm:w-16 h-12 sm:h-16' : 'w-10 sm:w-12 h-10 sm:h-12'} mb-2 sm:mb-3 flex items-center justify-center`}>
            <img 
              src={client.logo} 
    ...
    <div className="pt-16 sm:pt-20 overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold mb-6 sm:mb-8 leading-tight">
                ...
                <span className="block text-2xl sm:text-3xl lg:text-4xl xl:text-5xl mt-3 sm:mt-4 opacity-90">Since 1993</span>
              </h1>
            ...
            >
              ...
              <div className="relative bg-white rounded-sm p-6 sm:p-8 shadow-2xl border border-orange-100">
                ...
                <div className="absolute top-3 sm:top-4 right-3 sm:right-4 grid grid-cols-3 gap-1">
                  {[...Array(9)].map((_, i) => (
                    <div key={i} className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-orange-200 rounded-sm"></div>
                  ))}
                </div>
              </div>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center mb-12 sm:mb-16">
            <div className="relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-orange-500/5 to-red-500/5 rounded-sm blur-3xl -z-10" style={{ transform: 'scale(1.5)' }}></div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-20 lg:py-32 bg-white relative">
        <div className="absolute top-0 left-0 right-0">
          <svg viewBox="0 0 1440 320" className="w-full h-20 sm:h-32 fill-orange-50">
                ...
                <div className="relative bg-white rounded-sm p-6 sm:p-8 shadow-xl border border-gray-100 group-hover:shadow-2xl transition-all duration-300">
                  ...
                  <div className="flex items-center gap-3 sm:gap-4">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs sm:text-sm text-orange-600 font-medium truncate">{testimonial.company}</p>
                    </div>
                  </div>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-r from-orange-500 via-red-500 to-orange-600 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6">Ready to Experience Excellence?</h2>
